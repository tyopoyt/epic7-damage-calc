  ...
  doll_maker_pearlhorizon: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 1.5,
        pow: () => 0.9,
        extraDmg: (inputValues: DamageFormData) => inputValues.targetAsleep ? inputValues.targetFinalMaxHP() * 0.3 : 0,
  ...
  pearlhorizon: new Hero({
    ...
    skills: {
      ...
      s3: new Skill({
        ...
        rate: () => 1.5,
        pow: () => 0.9,
        extraDmg: (inputValues: DamageFormData) => inputValues.targetAsleep ? inputValues.targetFinalMaxHP() * 0.2 : 0,
